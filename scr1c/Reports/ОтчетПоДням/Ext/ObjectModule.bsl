Процедура УстановитьПараметры(Настройки)
	...
	Эл.Значение = НачалоМесяца(Дт);
	
	Эл = Настройки.ПараметрыДанных.Элементы.Найти("Дата2");
	Эл.Использование = Истина;
	Эл.Значение = КонецМесяца(Дт1)+1;
	
	Эл = Настройки.ПараметрыДанных.Элементы.Найти("НомЕд");
	Эл.Использование = Истина;
	Эл.Значение =  Константы.ксНоменклатураПереправаПоЕдиницам.получить();
